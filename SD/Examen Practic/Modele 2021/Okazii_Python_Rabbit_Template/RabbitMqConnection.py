...
# Interfata pentru Producer si pentru Consumer
...
# Routing key ofera date despre coada spre care se trimite
...
# Rabblit_queue este coada din care se citesc informatii
